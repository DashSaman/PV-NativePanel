...
export function RuntimeNaive() {
  ...
  const karingProfile = secret ? buildKaringSingBoxProfile(secret.username, secret.password, window.location.hostname) : "";
    ...
    <div className="runtime-page" dir="rtl">
      ...
      {secret && <div className="secret-backdrop" role="presentation">
        <section className="secret-dialog" role="dialog" aria-modal="true" aria-labelledby="secret-title">
          ...
          <p className="runtime-muted">خروجی Naive و کانفیگ سازگار با Karing را جداگانه کپی کنید:</p>
          ...
          <div className="secret-actions">
            ...
            <button onClick={() => navigator.clipboard.writeText(customerURI)}>کپی لینک Naive</button>
