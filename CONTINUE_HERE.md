...
Next executable slots: (1) Task13 current-main reconstruction + isolated live protocol rehearsal, (2) Task16 clean branch + repository-wide CI repair + four exact-head gates, (3) Karing real-client smoke, (4) independent RLS/accounting review, (5) read-only Production audit when a valid lane is available. Require fresh encrypted backup and independent rollback evidence before promotion.
