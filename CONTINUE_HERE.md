...
- #117 local web gates are green; Exact Accounting is green; main CI/Pinned Forwardproxy for the PR must finish before any merge decision.
...
## Execute next
1. Re-check all three exact-head workflows for #117. If green, perform independent diff/contract review; merge only with expected-head guard and only after all required review gates are real.
