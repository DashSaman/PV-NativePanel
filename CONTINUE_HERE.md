...
Verified checkpoint: 2026-09-13 07:37 Asia/Tehran

Pre-docs `main`: `f32e6e4748fef0e4f65f1c8e2f5a5d89300e5239`. No PR workflow runs are published for that documentation-only tip.

Do not deploy yet. Current executable lanes:
- **Karing PR #101**: canonical current-main reconstruction lane at exact head `216d53670066033403fe95f61b0402bb710186a3`. Exact-head CI `34732580376`, WS1 Exact Accounting `34732580468`, and WS1 Pinned Forwardproxy `34732580377` are all SUCCESS. Remaining gate is an independent real Karing import/parse/connect/cleanup smoke against a non-Production target using disposable credentials, exact generated-profile SHA-256, client/platform/version, redacted logs, and proof cleanup/revoke succeeded. Keep DRAFT until that evidence exists.
