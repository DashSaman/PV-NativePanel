...
- Latest verified `main` tip before this docs refresh: `183c914976ff2e56523a1dea70e543bc17d1cd9d`; this run adds documentation only. Combined status for the new docs head is empty; no post-merge CI is credited until observed.
...
- #81 Task16 OPEN/DRAFT, head `3c4310335ab4907d28bac995bba1be3545e14f6e`; current combined status empty; older dedicated PostgreSQL18 and stale-fixture evidence is supplemental; fresh single-SHA four-gate proof pending; Task15 schema20-specific fixtures must remain pinned.
