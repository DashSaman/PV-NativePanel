...
var Routes = []Route{
	...
	{"POST", "/api/v1/customers/{id}/suspend", "customers.suspend", Owner, true},
	{"POST", "/api/v1/customers/{id}/resume", "customers.resume", Owner, true},
	{"DELETE", "/api/v1/customers/{id}", "customers.delete", Owner, true},
	{"POST", "/api/v1/customers/{id}/rotate-password", "customers.password.rotate", Owner, true},
	{"POST", "/api/v1/customers/{id}/volume/add", "customers.volume.add", Owner, true},
	{"POST", "/api/v1/customers/{id}/validity/extend", "customers.validity.extend", Owner, true},
	{"POST", "/api/v1/customers/{id}/reset-usage", "customers.usage.reset", Owner, true},
	...
	{"POST", "/api/v1/users/{id}/reset-usage", "users.usage.reset", Owner, true},
	...
	{"GET", "/api/v1/pool/nodes", "pool.nodes.index", Owner, true},
	{"POST", "/api/v1/pool/enrollment-tokens", "pool.enrolltoken.create", Owner, true},
	{"POST", "/api/v1/pool/nodes", "pool.nodes.enroll", Owner, true},
	{"POST", "/api/v1/pool/nodes/{id}/revisions", "pool.revision.publish", Owner, true},
	{"GET", "/api/v1/pool/nodes/{id}/manifest", "pool.manifest.show", Owner, true},
	{"POST", "/api/v1/pool/nodes/{id}/maintenance", "pool.maintenance.set", Owner, true},
