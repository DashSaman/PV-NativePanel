...
func (f *endpointLoginStore) RecordLoginFailure(context.Context, string) (*time.Time, error) {
	return nil, nil
}
...
func (f *endpointLoginStore) ConsumeTOTPStepPreAuth(context.Context, string, int64) (bool, error) {
	return true, nil
}
func (f *endpointLoginStore) AppendAudit(context.Context, *string, string, string, string) error {
	return nil
}
