...
func TestCreateServiceTermPersistsAndReturnsAccountingBaseline(t *testing.T) {
	...
	conn := &customerScriptConn{queries: []customerScriptQuery{{
		...
		columns:  []string{"id", "tenant_id", "user_id", "quota_bytes", "concurrency_limit", "duration_seconds", "start_policy", "purchased_at", "starts_at", "first_connected_at", "expires_at", "state", "accounting_baseline_state", "accounting_baseline_source", "accounting_baseline_cutoff_at", "accounting_baseline_upload_bytes", "accounting_baseline_download_bytes", "revision"},
		values:   []driver.Value{"term-1", "tenant-1", "user-1", quota, int64(concurrency), int64(3600), "on_creation", now, now, nil, now.Add(time.Hour), "active", "known", "fresh_managed_term", now, int64(0), int64(0), int64(1)},
	}}}
...
func TestCreateProductServiceTermPersistsAndReturnsAccountingBaseline(t *testing.T) {
	...
	conn := &customerScriptConn{queries: []customerScriptQuery{{
		contains: "accounting_baseline_state",
		columns:  []string{"id", "tenant_id", "user_id", "plan_id", "quota_bytes", "duration_seconds", "no_expiry", "concurrency_limit", "start_policy", "purchased_at", "starts_at", "first_connected_at", "expires_at", "state", "renewal_kind", "renewed_from_term_id", "accounting_baseline_state", "accounting_baseline_source", "accounting_baseline_cutoff_at", "accounting_baseline_upload_bytes", "accounting_baseline_download_bytes", "revision"},
		values:   []driver.Value{"term-product", "tenant-1", "user-1", nil, quota, int64(3600), false, int64(concurrency), "on_creation", now, now, nil, now.Add(time.Hour), "active", "initial", nil, "known", "fresh_managed_term", now, int64(0), int64(0), int64(1)},
	}}}
	tx := newCustomerStoreTx(t, conn)
...
func TestCreateRenewalTermPersistsAndReturnsAccountingBaseline(t *testing.T) {
	...
	conn := &customerScriptConn{queries: []customerScriptQuery{{
		contains: "accounting_baseline_state",
		columns:  []string{"id", "tenant_id", "user_id", "plan_id", "quota_bytes", "duration_seconds", "no_expiry", "concurrency_limit", "start_policy", "purchased_at", "starts_at", "first_connected_at", "expires_at", "state", "renewal_kind", "renewed_from_term_id", "accounting_baseline_state", "accounting_baseline_source", "accounting_baseline_cutoff_at", "accounting_baseline_upload_bytes", "accounting_baseline_download_bytes", "revision"},
		values:   []driver.Value{"term-renew", "tenant-1", "user-1", nil, quota, int64(3600), false, int64(concurrency), "on_creation", now, now, nil, now.Add(time.Hour), "active", "renew_current", "old-term", "known", "fresh_managed_term", now, int64(0), int64(0), int64(1)},
	}}}
	tx := newCustomerStoreTx(t, conn)
