...
# Schema22 through schema17 are additive for this fixture.
# Step back 22 -> 21 -> 20 -> 19 -> 18 -> 17 -> 16, then prove immutable scheduler history still prevents
# the destructive schema16 rollback exactly as this regression test originally intended.
for want in 21 20 19 18 17 16; do
