...
[[ "${version}" == "14" ]] || { echo "ERROR: schema version=${version}, want=14" >&2; exit 1; }
...
# Exercise each destructive rollback in order: v14 -> v13 -> ... -> v3.
for want in 13 12 11 10 9 8 7 6 5 4 3; do
