...
[[ "${version}" == "15" ]] || { echo "ERROR: schema version=${version}, want=15" >&2; exit 1; }
...
# Exercise each destructive rollback in order: v15 -> v14 -> ... -> v3.
for want in 14 13 12 11 10 9 8 7 6 5 4 3; do
