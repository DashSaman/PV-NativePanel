...
- Authoritative `main`: `3e569ca7c43132d8618a4ac30d0117a26bb9230f`.
- `main` combined status and workflow queries returned zero published entries; no fresh post-update CI green result is claimed.
...
- PRs #85 and #86–#95 are stale-base or documentation reconciliation attempts; none are current runtime truth.
...
- Fresh dispatches were posted to PR #64 and PR #4.
