...
## Current truth
- Current authoritative `main` after this cycle's documentation reconciliation: `5db446a68955b120701940c624416d2ed9aee552`.
- The prior inspected checkpoint `d2098ebd0d09dc78b77a78c8d636d85ca9fc62da` had successful GitHub Actions CI run `34685323713` / run `1786` (completed 2026-09-12 09:18Z). The new docs tip has no published CI result in the available lookup and is not claimed green.
...
5. CI lane: obtain published same-head green CI for the current `main` tip and any candidate integration head.
