...
Checkpoint: 2026-09-13 14:40 Asia/Tehran

- Verified pre-refresh `main`: `24229de505b76713b044de435398960a41779f51`; push CI run `34751205133` completed SUCCESS.
...
- Karing PR #101 remains OPEN/DRAFT at exact head `216d53670066033403fe95f61b0402bb710186a3`. Repository CI/accounting/forwardproxy gates are green. Keep DRAFT until independent real-client import/parse/connect/cleanup validation is attached and independently reviewed.
