...
## Current truth
- Current authoritative `main` after this documentation refresh is expected to advance from `96bc28c661b349cf4b95c4822f2807151a7da7b9` by documentation-only commits.
- No published CI result is available for the exact current-main checkpoint; do not claim green.
